            ...
            <VStack spacing={100}>
              ...
              { projectsToVote && projectsToVote.length > 0 && (
                <Stack id="vote"    
                  ...
                  <Box borderTop={'1px solid #000000'} borderBottom={'1px solid #000000'}  bg={'#FEE75C'} py={'10px'} w={'110vw'} position={'relative'} left={-10}>
                  ...
                  <Flex  align={'center'} direction={{base:'column', md: 'row'}} justify={{base:'center', md: 'space-between'}}>
                    ...
                    <VStack mr={200}>
                      ...
                      <Text hidden={isMobile} textAlign={{base:'center', md: 'start'}} fontSize={"40px"} lineHeight="10" fontWeight="bold">{getEndVotingPeriod()}</Text>
                    </VStack>
                  </Flex>
