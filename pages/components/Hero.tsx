        ...
        <Stack spacing={{ base: "8", md: "10" }}>
          <Stack spacing={{ base: "4", md: "5" }} align="center">
            ...
            <Text
              ...
              fontSize="24px"
            >
              Why participate in an IDO, when you can{" "}
              <Text as={"b"}>support</Text> crypto projects & mint native tokens
              or NFTs{" "}
              <Text as={"b"}>
                with your staking rewards, not your crypto assets
              </Text>
              .
            </Text>
          </Stack>
          ...
          >
            ...
            >
              ...
              <Text textAlign={"center"} w={"70%"} opacity={0.5}>
                Financially support NEAR projects with you stNEAR tokens and get
                rewards
              </Text>
