export const data = [
  ...
  },
  {
    ...
    description:
      `Cheddar is a loyalty protocol on NEAR that provides fun and low risk ways to learn NEAR, crypto, and DEFI. Cheddar rewards loyal users with Cheddar and other tokens through its partners, farm, and games.`,
    verified: true,
