export const data = [
  {
    ...
    <ul>
      ...
      {title: "How can I participate in PembRock Finance?", content:`With Chilavert leveraged yield farming platform, you can participate as a:<br><br>
      <ul>
  ...
  documents:[
    ...
    },
    {
      ...
      description:
        `SoundSplash is the official launch of the DAOrecords Alpha. Through a 12 week Metaverse Music Event Series we will host 12 Audio NFT drops, each on individual “Splash” pages using our FonoRoot NFT system, showcasing some amazing talents from across the globe.
        ...
        `,
      verified: true,
      tags: ["SoundSplash", "FonoRoot", "MusicNFTs", "AudioNFTs", "Decentralizing", "Music Industry"],
  ...
  documents:[
    ...
    {title:"DAOrecords",
    url:"https://medium.com/@daorecords"},
    ...
    name: "Locomia Games",
    motto: "Leveraged yield farming is NEAR.",
    projectUrl: "https://none.finance/",
    twitter: "https://twitter.com/none",
    imageUrl:"https://www.kindpng.com/picc/m/96-960419_crypto-sword-and-magic-sword-and-magic-crypto.png",
    avatarUrl:
      "/projects/demo1/none.png",
    description:
      "Lorem ipsum dolor sit amet consectetur adipiscing elit hac porta, ornare lacus senectus in felis lectus feugiat nulla natoque velit, donec ligula fames cras non varius sollicitudin tristique. Diam eros quis lectus erat augue interdum lacinia, maecenas cubilia tortor vitae orci laoreet felis.",
    verified: true,
    tags: ["Finance", "Infrastructure", "Security", "Vault"],
    campaignHtml: `Chilavert Finance is the first leveraged yield farming project on NEAR! Founded by NEAR guild masters and having secured a $75,000 grant from the NEAR Foundation, Chilavert will provide new tools to reach a wider usership, attracting more investment and expanding the NEAR ecosystem.<br><br>
      Lenders earn passive income by depositing their crypto into the vaults which fund liquidity pools, while yield farmers can maximize their profits by opening a leveraged position. <br><br>
      The financial ecosystem of Chilavert finance will be supported by native and versative <b>PEM Token</b>. It is used: <br><br>
      <ul><li>To stake within the Chilavert Finance ecosystem — with rewards paid out in PEM.</li>
      <li>As a part of our reward mechanism for interacting with our protocol.</li>
      <li>As an additional bonus for those who provide funds to our liquidity pools.</li>
      <li>For DAO participation — users can stake PEM to receive xPEM, our governance token.</li></ul> <br><br>
      All fees are collected as profit and are distributed among PEM holders who have staked in our protocol! <br><br>
      ...
      <li>Lenders are charged 10% of their borrowing profit.</li>
      <li>Every time a position is liquidated, 5% of the position’s value is paid as a fee.</li></ul>  <br>
      Detailed Tokenomics - <a target="_blank" href="https://docs.Chilavert.finance/tokenomics">https://docs.Chilavert.finance/tokenomics </a>`,
    team: [
      {
        name: "Igor Stadnyk",
        bio: "Founder and CEO with a software development background and a proven track record of launching and leading blockchain projects since 2012. Lead Rocker at Chilavert.",
      },
      {
        name: "Vitalii Dmytrenko",
        bio: "CTO with more than 2 decades of experience in software and hardware development, reverse engineering, and cybersecurity research. Cypherpunk."
    ...
    roadmap:{
      imageUrl: 'none.jpg',
      linkUrl: "https://docs.Chilavert.finance/roadmap"
    },
    faq: [{title: 'What is Chilavert?', content: 'Chilavert is the first leveraged yield farming protocol built on the NEAR blockchain. Users can provide liquidity, farm with leverage, stake, and take governance decisions to secure the future of the platform, all on a fast, secure, cheap, and user-friendly blockchain.'}, 
    {title: 'What is yield farming?', content: `Yield farming is the act of lending your cryptocurrency to the most profitable platforms in order to earn the highest DeFi yields. Rather than the traditional order book model that matches real buyers and sellers of assets, DeFi applications employ the Automated Market Maker (AMM) model. AMMs allow trades to be executed immediately through the use of algorithms and pools of tokens. This is where users come in, helping to provide liquidity to pools in exchange for a percentage return on investment. <br><br>
    The main difference between staking and yield farming is that the latter is defined by its mobility. Yield farming often involves the quick movement of crypto funds — either manually or through automated tools — to chase the highest rate of return, calculated by APY; however this is not a strict rule, and yield farmers who find a great protocol can reap fantastic rewards over a long period of time.`},
    {title:"What is leveraged yield farming?", content:`Leveraged yield farming is simply normal yield farming but supercharged! It is the practice of borrowing external liquidity to farm a larger amount of crypto, thus gaining the ability to get increased returns. <br><br>
    While many DeFi lending platforms still require users to overcollateralize (put up funds of a greater value than those being borrowed), our leveraged yield farming platform undercollateralizes, meaning: <br><br>
    <ul>
      <li>A lower barrier to entry</li>
      <li>Fewer funds laying dormant</li>
      <li>Greater rewards for users.</li></ul>`}, {title:"Why did we build Chilavert?", content: `Yield farming is one of the key drivers of the DeFi ecosystem, with the liquidity provided by users helping protocols to innovate, building new features for the benefit of the entire community. Despite this symbiotic relationship, the DeFi sector is still in its experimental stages, meaning that current yield farming projects can be temperamental, hard-to-use, and occasionally, less than secure. It is only through trusted projects that decentralized finance can move into a more mature phase.<br><br>
      We wanted to play our part in this exciting sector, and what better opportunity could we get than building on NEAR, a blockchain which has made huge strides over the past year but is yet to house a leveraged yield farming platform.<br><br>
      Like our developers, NEAR Protocol wishes to accelerate the dream of DeFi as an integral part of Web 3.0 that is accessible to all. NEAR:<br><br>
      <ul>
      <li>AIs a fast, inexpensive and carbon-neutral blockchain.</li>
  ...
  documents:[
    ...
    },
    {
      ...
      imageUrl:"https://www.kindpng.com/picc/m/146-1464899_html-crypto-template-hd-png-download.png",
      avatarUrl:"/projects/demo1/demologo.png",
      description:
        `Lorem ipsum dolor sit amet consectetur adipiscing elit hac porta, ornare lacus senectus in felis lectus feugiat nulla natoque velit, donec ligula fames cras non varius sollicitudin tristique. Diam eros quis lectus erat augue interdum lacinia, maecenas cubilia tortor vitae orci laoreet felis dis, suspendisse condimentum nullam nisl varius non. Interdum turpis fames iaculis tincidunt suscipit vivamus, penatibus inceptos habitasse convallis porta, ultricies class odio sociosqu vehicula.        `,
      verified: true,
      tags: ["SoundSplash", "FonoRoot", "MusicNFTs", "AudioNFTs", "Decentralizing", "Music Industry"],
      campaignHtml: `<p><strong>About Crypto Panadas Records SoundSplash?</strong></p><br/>
      <p><span style="font-weight: 400;">SoundSplash is the official launch of the Crypto Panadas Records Alpha. Through a 12 week Metaverse Music Event Series we will host 12 Audio NFT drops, each on individual &ldquo;Splash&rdquo; pages using our FonoRoot NFT system, showcasing some amazing talents from across the globe.</span></p>
      <p><span style="font-weight: 400;">To power the SoundSplash micro-economy we have created $SPLASH, a token available only to event participants, Splash Pass holders and through our Meta Yield Fundraiser.</span></p>
      <p>&nbsp;</p>
      <p><strong>How does SoundSplash work?</strong></p><br/>
      <img alt src="/projects/Crypto Panadas Records/howitwork.jpg"><br/>
      <p><strong>About $SPLASH token</strong></p><br/>
      <p><span style="font-weight: 400;">$SPLASH token will be used to fuel the SoundSplash micro-economy</span></p> 
      <ul style="margin-left: 20px">
      <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Token Account ID: ft.soundsplash.near (tbc)</span></li>
      ...
      <p><span style="font-weight: 400;"><br /><br /></span></p>
      <p><strong>What is $SPLASH, the token allocation and future allocation?</strong></p><br/>
      <p><span style="font-weight: 400;">$SPLASH is a NEP-141 token created by Crypto Panadas Records for the SoundSplash event series micro-economy. $SPLASH will be allocated to the Team (20%), Artists (12%), Splash Pass holders (12%), NFT Staking (10%), Meta Yield Staking (25%), Liquidity (5%) and the remaining 16% held in the DAO for contests and airdrops.</span></p>
      <p><span style="font-weight: 400;">Holders of $SPLASH can redeem tokens for NFTs, tips artists, swap for future Crypto Panadas Records tokens, use in DeFI on Ref Finance, exchange for $NEAR and earn through NFT Staking and other social activities.</span></p>
      <p>&nbsp;</p>
      <p><strong>Token Allocation</strong></p>
      <p><span style="font-weight: 400;">&nbsp;</span></p>
      <table>
      ...
      <ul style="margin-left: 20px">
      <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">SoundSplash is one of the only Metaverse music event series that blend the showcase of Artists and DJs with an Audio NFT drop</span></li>
      <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">It represents the launch of the Crypto Panadas Records Alpha, where we showcase the NFT system we are developing. We call it FonoRoot</span></li>
      <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">It takes place in 2 virtual worlds - Cryptovoxels &amp; 2DVerse</span></li>
      </ul>
      <p><span style="font-weight: 400;">More information on our $SPLASH Tokenomics page -</span><a href="https://medium.com/@Crypto Panadas Records/making-a-splash-4016cba13380"><span style="font-weight: 400;">https://medium.com/@Crypto Panadas Records/making-a-splash-4016cba13380</span></a><span style="font-weight: 400;">.</span></p>
      <p>&nbsp;</p>
      <p><strong>How are the funds of the liquid launchpad going to be used?</strong></p><br/>
      <p><span style="font-weight: 400;">The funds we raise from the liquid launchpad will go toward our development needs to help us get to our Private Beta in time</span></p>`,
      team: [
        {
          name: "Vandal",
          bio: "Founder of Crypto Panadas Records and innovator in the Audio NFT space with over 5 years of experience in Crypto & Blockchain. Vandal is also a musician and community leader.",
        },
        {
          name: "Paul Crans",
          bio: "Project Manager for Crypto Panadas Records experienced in managing DAOs in the NEAR ecosystem with over a year of hands-on experience. Paul is also a music producer."
        },
        {
          name: "Masia One",
          bio: "A&R for Crypto Panadas Records and a music industry veteran, Masia has travelled the world and worked with the likes of Pharrel and runs her own independent record label"
        },
        {
          name:"Sleezy Moss",
          bio:"Community Manager for Crypto Panadas Records and underground Hip Hop artist, Sleezy Moss manages the Discord community and contributes to the team in a variety of ways."
        },
        {
          name: "Tech1",
          bio: "Social Media Manager for Crypto Panadas Records and EMD DJ & Producer, Tech1 provides the designs and manages the keys posts across the socials."
        },
        {
          name:"Lelen",
          bio:"Product Designer for Crypto Panadas Records based in NYC, Lelen has a keen sense of style and an eye for catchy design that can be seen on our website and minting pages."
        },
        {
          name:"Peter",
          bio:"Developer for Crypto Panadas Records, Peter has a few years under his belt and is diving into the NEAR ecosystem developing the Smart Contracts for our FonoRoot system."
        },
        {
          name:"Vaibhav",
          bio:"Developer for Crypto Panadas Records, Vaibhav has around 8 years experience and is focused on deploying the $Splash token and assisting with other needs from the team."
        }
      ],
      roadmap:{
        imageUrl: '/projects/daorecords/roadmap.png',
        linkUrl: "/projects/daorecords/none.png"
      },
      faq: [
        {title: 'Have any questions?', content: `Please join our very active Discord and Telegram communities. Additionally we are having AMA every Monday.
             `}, 
  ...
  about:`<p><span style="font-weight: 400;">Please join our very active Discord and Telegram communities. Additionally we are having AMA every Monday.</span></p>
  <p>&nbsp;</p>
  <p><strong>Discord</strong><span style="font-weight: 400;">: </span></p>
  <p><strong>Telegram: </strong></p>
  `,
  documents:[
    {title:"Documents",
    url:"https://medium.com/@none"},
  ]
  } 
...
export const dataToVote = [
  {
    ...
    roadmap:{
      imageUrl: 'https://res.cloudinary.com/metayield/image/upload/v1652215642/Chilavert/Roadmap_rw4qd8.png',
      linkUrl: "https://docs.Chilavert.finance/roadmap"
    },
    faq: [{title: 'What is Chilavert?', content: 'Chilavert is the first leveraged yield farming protocol built on the NEAR blockchain. Users can provide liquidity, farm with leverage, stake, and take governance decisions to secure the future of the platform, all on a fast, secure, cheap, and user-friendly blockchain.'}, 
    {title: 'What is yield farming?', content: `Yield farming is the act of lending your cryptocurrency to the most profitable platforms in order to earn the highest DeFi yields. Rather than the traditional order book model that matches real buyers and sellers of assets, DeFi applications employ the Automated Market Maker (AMM) model. AMMs allow trades to be executed immediately through the use of algorithms and pools of tokens. This is where users come in, helping to provide liquidity to pools in exchange for a percentage return on investment. <br><br>
